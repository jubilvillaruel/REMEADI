const meditationDescDB = {
    ...
    'Hatha Yoga' : "Sanskrit word “hatha” can be translated in English two different ways: as “willful” or “forceful,” as the active path of yoga—or as “sun” (ha) and “moon” (tha), as the yoga of balance. Taken together, hatha yoga can be described as a set of willful and active practices that aim to achieve harmony and balance in the mind, body, and spirit.",
